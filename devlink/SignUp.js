...
export function SignUp({ as: _Component = _Builtin.BlockContainer }) {
  return (
    <_Component
    ...
    >
      <_Builtin.FormWrapper className={_utils.cx(_styles, "ms-form-block")}>
        <_Builtin.FormForm
          ...
          name="wf-form-Signup-Form-Two"
          data-name="Signup Form Two"
          method="get"
          data-ms-form="signup"
          id="wf-form-Signup-Form-Two"
        >
          <_Builtin.Heading
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "ms-list-container")}
            tag="div"
          >
            <_Builtin.FormCheckboxWrapper
              ...
              data-ms-member="consent"
            >
              <_Builtin.FormCheckboxInput
                className={_utils.cx(_styles, "ms-checkbox")}
                type="checkbox"
                name="Terms-Two-2"
                data-name="Terms Two 2"
                required={true}
                checked={false}
                id="Terms-Two-2"
                form={{
              ...
              <_Builtin.FormInlineLabel
                className={_utils.cx(_styles, "ms-checkbox-label")}
              >
                {"I agree to the "}
                <_Builtin.Link
            ...
            >
              <_Builtin.FormCheckboxInput
                className={_utils.cx(_styles, "ms-checkbox")}
                type="checkbox"
                name="Subscribe-Two-2"
                data-name="Subscribe Two 2"
                required={false}
                checked={false}
                data-ms-member="subscribe"
                id="Subscribe-Two-2"
                form={{
                  type: "checkbox-input",
                  name: "Subscribe Two 2",
          ...
          <_Builtin.Link
            ...
            block="inline"
            options={{
              href: "https://docs.memberstack.com/hc/en-us/articles/7424129003547-Create-a-Signup-Form-in-Webflow",
              target: "_blank",
            }}
          >
            <_Builtin.Block
